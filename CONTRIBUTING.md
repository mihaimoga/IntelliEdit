...
***Ask not what IntelliEdit can do for you - ask what you can do for IntelliEdit***
...
2. Include additional information such as:
    ...
    * IntelliEdit Debug-Info containing:
...
1. Respect existing IntelliEdit coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
