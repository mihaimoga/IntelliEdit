...
// IntelliEditDoc.h : interface of the CIntelliEditDoc class
//
...
class CIntelliEditDoc : public Scintilla::CScintillaDoc
{
protected: // create from serialization only
	CIntelliEditDoc() noexcept;
	DECLARE_DYNCREATE(CIntelliEditDoc)
